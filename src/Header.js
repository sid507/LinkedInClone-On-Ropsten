...
import { Home, MessageOutlined, Notifications, People, Search } from '@material-ui/icons'
        ...
        <div className="flex justify-between mx-3.5 p-1 ">
            ...
            <div className="flex flex-row gap-4 mr-10  my-auto">
                ...
                <div className="flex flex-col  ">
                    ...
                    <People className="mx-2  "></People>
                  
                    <p className="text-sm">People</p>
                </div>
                <div className="flex flex-col ">
                    
                    <MessageOutlined className="mx-auto "></MessageOutlined>
                  
                    <p className="text-sm">Message</p>
                </div>
                <div className="flex flex-col  ">
                    
                    <Notifications className="mx-auto "></Notifications>
